...
{
    public partial class frmBill_update : Form
    {
        SqlConnection conn;

        public frmBill_update()
        {
            InitializeComponent();
        }
        ...
        private void frmProduct_update_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'qUANLIKINHDOANHDIENTHOAIDataSet.tblBillDetail' table. You can move, or remove it, as needed.
            ...
            // TODO: This line of code loads data into the 'qUANLIKINHDOANHDIENTHOAIDataSet.tblBillDetail' table. You can move, or remove it, as needed.
            this.tblBillDetailTableAdapter.Fill(this.qUANLIKINHDOANHDIENTHOAIDataSet.tblBillDetail);
            // TODO: This line of code loads data into the 'qUANLIKINHDOANHDIENTHOAIDataSet.tblBill' table. You can move, or remove it, as needed.
        ...
        {
            cmbBill_Id.Enabled = false;
            cmbBillDetail_ParcelNumber.Enabled = false;
            cmbBillDetail_ProductId.Enabled = false;
            cmbBill_Id.SelectedValue = dgvBillDetail.CurrentRow.Cells[0].Value;
            cmbBillDetail_ParcelNumber.SelectedValue = dgvBillDetail.CurrentRow.Cells[1].Value;
            cmbBillDetail_ProductId.SelectedValue = dgvBillDetail.CurrentRow.Cells[2].Value;
            txtBillDetail_Quantity.Text = dgvBillDetail.CurrentRow.Cells[3].Value.ToString();
        }
        ...
        {
            txtKindBill_Id.Enabled = false;
            txtKindBill_Id.Text = dgvKindBill.CurrentRow.Cells[0].Value.ToString();
            txtKindBill_Name.Text = dgvKindBill.CurrentRow.Cells[1].Value.ToString();
        }
        ...
        private void dgvBillDetail_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            using (SolidBrush b = new SolidBrush(dgvBillDetail.RowHeadersDefaultCellStyle.ForeColor))
            {
                e.Graphics.DrawString((e.RowIndex + 1).ToString(), e.InheritedRowStyle.Font, b, e.RowBounds.Location.X + 10, e.RowBounds.Location.Y + 4);
            }
        }
        ...
        {
            using (SolidBrush b = new SolidBrush(dgvKindBill.RowHeadersDefaultCellStyle.ForeColor))
            {
                e.Graphics.DrawString((e.RowIndex + 1).ToString(), e.InheritedRowStyle.Font, b, e.RowBounds.Location.X + 10, e.RowBounds.Location.Y + 4);
            }
        }
